...
for row in axs:
    for ax in row:
        ax.set(xticks=[], yticks=[], xlim=(0, 6), ylim=(0.0, 2.0))
...
for given in givens:
    ...
    for row, roww00, roww01, roww10, roww11, roww12, roww21, roww22, rowZ in zip(axs, w00, w01, w10, w11, w12, w21, w22, Z):
        for ax, w00e, w01e, w10e, w11e, w12e, w21e, w22e, ze in zip(row, roww00, roww01, roww10, roww11, roww12, roww21, roww22, rowZ):
            for line in ax.get_lines():
                line.remove()
            xaxis = [1, 2, None, None, None]
            yaxis = [w00e, w01e, None, None, None]
            ax.plot(xaxis, yaxis, c=ze, linewidth=3, marker='o', markerfacecolor='white', markersize=3)
            yaxis = [w11e, w10e, None, None, None]
            ax.plot(xaxis, yaxis, c=ze, linewidth=3, marker='o', markerfacecolor='white', markersize=3)
            xaxis = [None, None, None, 4, 5]
            yaxis = [None, None, None, w11e, w12e]
            ax.plot(xaxis, yaxis, c=ze, linewidth=3, marker='o', markerfacecolor='white', markersize=3)
            yaxis = [None, None, None, w22e, w21e]
            ax.plot(xaxis, yaxis, c=ze, linewidth=3, marker='o', markerfacecolor='white', markersize=3)
